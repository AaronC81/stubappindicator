...
Modified to be a library stub by Aaron Christiansen.
...
AppIndicator *app_indicator_new(const gchar *id,
                                ...
                                AppIndicatorCategory category) { return 0x1337; }

AppIndicator *app_indicator_new_with_path(const gchar *id,
                                          const gchar *icon_name,
                                          AppIndicatorCategory category,
                                          const gchar *icon_theme_path) { return 0x1337; }
...
/* Get properties */
const gchar *app_indicator_get_id(AppIndicator *self) { return "hello"; }
AppIndicatorCategory app_indicator_get_category(AppIndicator *self) { return 0; }
AppIndicatorStatus app_indicator_get_status(AppIndicator *self) { return 0; }
const gchar *app_indicator_get_icon(AppIndicator *self) { return "hello"; }
const gchar *app_indicator_get_icon_desc(AppIndicator *self) { return "hello"; }
const gchar *app_indicator_get_icon_theme_path(AppIndicator *self) { return "hello"; }
const gchar *app_indicator_get_attention_icon(AppIndicator *self) { return "hello"; }
const gchar *app_indicator_get_attention_icon_desc(AppIndicator *self) { return "hello"; }
const gchar *app_indicator_get_title(AppIndicator *self) { return "hello"; }

GtkMenu *app_indicator_get_menu(AppIndicator *self) { return 0x1337; }
const gchar *app_indicator_get_label(AppIndicator *self) { return "hello"; }
const gchar *app_indicator_get_label_guide(AppIndicator *self) { return "hello"; }
guint32 app_indicator_get_ordering_index(AppIndicator *self) { return 0x1337; }
GtkWidget *app_indicator_get_secondary_activate_target(AppIndicator *self) { return 0x1337; }
